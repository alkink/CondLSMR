...
class CondLSTR2DRes18(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        _, h_enc, w_enc = enc_outs[3]
        enc_feat = enc_outs[0].view(h_enc, w_enc, B, -1).permute(2, 3, 0, 1).contiguous()
