...
class CULaneDataset(Dataset):
    ...
    def __init__(self, root, split='train', transform=None, version='v1.0'):
        ...
        self.ann_file = os.path.join(self.root, 'culane_infos_{}_{}.pkl'.format(self.split, self.version))
        ...
        self.test_mode = self.split in ('test', 'test_2k')
    ...
    def __getitem__(self, index):
        ...
        file_name = input_dict['filename']
        input_dict['filename'] = ','.join(file_name.split('/')[-3:])
